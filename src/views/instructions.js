        ...
        <li>
          <ul>
            <li>
              ...
              enemigo, se desplegará un mensaje de <span style={{'background':'red'}}><strong>FUEGO!</strong></span> y el
              tablero se marcará con una 'X'.
            </li>
            <br />
            <li>
              Si erras el disparo, la bala llegará al agua, por lo que se
              desplegará un mensaje <span style={{'background':'blue'}}><strong>AGUA!</strong></span> y el tablero se
              marcará con olas '~~'.
              <br />
              <img
            ...
            <li>
              ...
              Se despliega un mensaje de <span style={{'background':'yellow'}}>'Hundido!'</span>
            </li>
          </ul>
        </li>
        <li>
